...
cdef extern from "cuda.h" nogil:
    cpdef enum cudaDeviceAttr:
        ...
        # cudaDevAttrReservedSparseCudaArraySupported = 112
        # cudaDevAttrReservedReadOnlyHostRegisterSupported = 113
    ...
    ctypedef struct cudaDeviceProp:
        ...
        # int  reservedSparseCudaArraySupported
        # int  reservedReadOnlyHostRegisterSupported
